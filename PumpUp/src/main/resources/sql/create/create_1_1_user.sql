...
CREATE SEQUENCE IF NOT EXISTS user_seq INCREMENT BY 1 START WITH 1 NOCYCLE;
CREATE SEQUENCE IF NOT EXISTS weighthistory_seq INCREMENT BY 1 START WITH 7 NOCYCLE;
CREATE SEQUENCE IF NOT EXISTS bodyfathistory_seq INCREMENT BY 1 START WITH 7 NOCYCLE;
