...
MERGE INTO ExerciseSet VALUES
  ...
  (7, 13, NULL, 12, 'repeat', 7, 1, FALSE), (8, 13, NULL, 12, 'repeat', 8, 1, FALSE),
  (9, 13, NULL, 12, 'repeat', 9, 1, FALSE), (10, 5, NULL, 12, 'repeat', 10, 1, FALSE),
  (11, 5, NULL, 12, 'repeat', 11, 1, FALSE), (12, 5, NULL, 12, 'repeat', 12, 1, FALSE),
  (13, 18, NULL, 12, 'repeat', 13, 1, FALSE), (14, 18, NULL, 12, 'repeat', 14, 1, FALSE),
  (15, 18, NULL, 12, 'repeat', 15, 1, FALSE), (16, 9, NULL, 1, 'time', 16, 1, FALSE),
  ...
  (39, 0, NULL, 20, 'repeat', 3, 3, FALSE), (40, 13, NULL, 16, 'repeat', 4, 3, FALSE),
  (41, 13, NULL, 12, 'repeat', 5, 3, FALSE), (42, 13, NULL, 10, 'repeat', 6, 3, FALSE),
  ...
  (51, 3, NULL, 20, 'repeat', 3, 4, FALSE), (52, 14, NULL, 20, 'repeat', 4, 4, FALSE),
  (53, 14, NULL, 16, 'repeat', 5, 4, FALSE), (54, 14, NULL, 20, 'repeat', 6, 4, FALSE),
  (55, 16, NULL, 20, 'repeat', 7, 4, FALSE), (56, 16, NULL, 20, 'repeat', 8, 4, FALSE),
  (57, 16, NULL, 20, 'repeat', 9, 4, FALSE);

  MERGE INTO appointment VALUES
  (1, CURRENT_DATE(), 1, 1, FALSE, FALSE);
