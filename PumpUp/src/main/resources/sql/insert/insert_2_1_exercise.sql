...
MERGE INTO exercise KEY (id) VALUES
  (0, 'Liegestütz',
   'Legen Sie sich auf den Bauch, strecken Sie die Beine, schließen Sie die Füße und stellen Sie die Zehenspitzen auf. Die Hände sind direkt unter den Schultern. Stemmen Sie sich nun vom Boden hoch. Ihr Körper sollte während der Bewegung eine gerade Linie bilden, von den Fersen bis zum Nacken.',
   1.0, 'pushup.mp4',
   NULL, FALSE),
  (1, 'Armrotation', 'Eine tolle Übung, um die Schultern vor oder nach den intensiveren Übungen aufzuwärmen oder abzukühlen. Armrotationen sind besonders dann geeignet, wenn man nach einer Verletzung oder im Alter gerade wieder mit dem Training beginnt. Stellen Sie sich aufrecht hin, strecken Sie die Arme seitlich aus und machen Sie kleine oder große Kreise.   Zuerst kreisen Sie zehnmal in die eine, dann in die andere Richtung.', 0.5, 'armrotation.mp4', NULL, FALSE),
  (2, 'Daumen hoch', 'Nehmen Sie die Bauchlage ein. Ihre Füße sind hüftbreit geöffnet, die Fußspitzen aufgestellt. Strecken Sie die Arme seitlich aus und ballen Sie Ihre Hände zu Fäusten, die Daumen zeigen nach oben. Heben Sie nun die Schultern und den Kopf vom Boden an und ziehen Sie die gestreckten Arme so weit wie möglich nach oben. Dabei nähern sich Ihre Schulterblätter an.', 0.5, 'armup.mp4', NULL, FALSE),
  ...
  (10, 'Seilspringen', 'Versuchen Sie eine geringe Sprunghöhe um Kraft zu schonen und versuchen Sie es auch einmal rückwärts', 0.4, 'schnurspringen.mp4', NULL, FALSE),
  (11, 'BOXEN-Schläge', 'Stellen Sie sich schulterbreit vor den Box/Sandsack und schlagen führen Sie gezielte Schläge aus', 0.6, 'boxen_schlaege.mp4', NULL,
   FALSE),
  ...
  (21, 'Schultern dehnen', 'Positionieren Sie einen Arm so, dass er parallel zu Ihrem Oberkörber ist. Greifen Sie nun mit dem der anderen Hand auf Ihren zu dehnenden Oberarm und ziehen Sie sanft in Richtung ihres Oberkörpers. Nun sollten Sie im Oberarm bereits eine Dehnung merken.', 0.5, NULL, NULL, FALSE),
  (22, 'Rücken (oben) dehnen', 'Stellen Sie sicht aufrecht hin und strecken Ihre Arme vor sich aus. Führen Sie nun ihre beiden Hände ineinander über und drehen diese so, dass ihre Handflächen von Ihnen weg schauen. Achten Sie hier auf einen geraden Rücken und dass Sie nicht zu viel Druck ausüben.', 0.5, NULL, NULL, FALSE),
  (23, 'Rücken (Mitte) dehnen', 'Knien Sie in die Yoga Katzenposition mit Händen und Knien auf dem Boden. Drücken Sie nun Ihren Rücken in Richtung des Bodens. Hier ist besonders wichtig nicht zu viel Druck auszuüben und sanft zu beginnen.', 0.5, NULL, NULL, FALSE),
...
MERGE INTO exercise_category KEY (exerciseid, categoryid) VALUES
  ...
  (11, 0), (11, 1), (11, 18), (11, 4), (11, 5), (11, 6), (11, 7), (11, 8),
  --boxen tritte, kraft, sandsack
  (12, 1), (12, 18), (12, 4), (12, 10), (12, 11), (12, 12), (12, 8),
